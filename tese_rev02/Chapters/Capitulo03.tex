...
Na Figura \ref{fig:cumula_t8}, para $n=4$, o valor do \dmc~varia entre $0.52$ e $0.68$ aproximadamente, para a escala temporal $n=69$, os valores variam apenas na segunda casa decimal. Para o canal \emph{Af3}, escolhido por ser o canal de maior \dmc~em relação aos outros $63$ canais, apresenta variação na terceira casa decimal para a escala $n=4$ e na quarta casa para a escala $n=69$. Para os dados analisados, quanto maior a correlação do canal com o sistema, menor a variação cumulativa do coeficiente \dmc. Este resultado precisa ser analisado com mais dados e outros conjuntos  de variáveis, incluindo conjuntos de séries com características de multi-correlação diferentes.


\subsection{Conclusão}

Os critérios $|$ \pdcca $|$~e $\Sigma DPDCCA$~apresentaram resultados interessantes  na maximização do coeficiente \dmc em relação ao total. É recomendado a repetição do experimento em mais escalas temporais e com outros canais como variável dependente, comparando com o valor máximo do \dmc calculado para cada combinação de resultado possível.
