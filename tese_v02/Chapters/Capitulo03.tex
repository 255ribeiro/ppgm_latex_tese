...
\begin{figure}[!htb]
	...
	\includegraphics[width=.8\textwidth]{../Figures/art_02/std pop.jpg}
...
\begin{figure}[!htb]
	...
	\includegraphics[width=.8\textwidth]{../Figures/art_02/mean.jpg}
	\\{\footnotesize Fonte: Elaborada pelos autores}
	\label{fig:a01_mean}
\end{figure}
...
\begin{figure}[!htb]
	...
	\includegraphics[width=.8\textwidth]{../Figures/art_02/median.jpg}
	\\{\footnotesize Fonte: Elaborada pelos autores}
